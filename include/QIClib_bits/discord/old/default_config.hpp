...
double _discord3_local_xtol = _precision::eps<double>::value;
...
double _discord3_prob_tol = _precision::eps<double>::value;
...
double _discord_local_xtol = _precision::eps<double>::value;
...
double _discord_prob_tol = _precision::eps<double>::value;
...
double _deficit3_local_xtol = _precision::eps<double>::value;
...
double _deficit_local_xtol = _precision::eps<double>::value;
