...
template< typename T1, typename TR =
          typename std::enable_if < is_floating_point_var< eT<T1> >::value,
                                    eT<T1>
                                    >::type >
inline
...
template< typename T1, typename TR =
          typename std::enable_if< is_floating_point_var<T1>::value,
                                   T1
                                   >::type >
inline
...
template< typename T1, typename T2, typename TR =
          typename std::enable_if < std::is_arithmetic<T1>::value
                                    ...
                                    T1 >::type >
    inline
    TR renyi_prob(const std::initializer_list<T1>& prob1,
                  const T2& alpha
                  ) {
